...
public static class Recursion
{
    ...
    {
        // Initialize remember dictionary if it's null
        if (remember == null)
        {
        ...
        // Base Cases
        if (s == 0) // Corrected base case for s=0
            return 1;
        if (s == 1)
            return 1;
        if (s == 2)
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // Base Case: If no wildcard is found, add the current pattern to results and return.
        if (wildcardIndex == -1)
        {
            results.Add(pattern);
            return;
        ...
        // Recursive Step: Replace the wildcard with '0' and '1' and make recursive calls.
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // Backtrack so other recursive paths can reuse this coordinate
        currPath.RemoveAt(currPath.Count - 1);
    }
}
